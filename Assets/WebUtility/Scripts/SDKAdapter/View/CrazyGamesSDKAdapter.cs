...
[CreateAssetMenu(fileName = "CrazyGamesSDKAdapter", menuName = "SDKAdapter/CrazyGames")]
public class CrazyGamesSDKAdapter : AbstractSDKAdapter
{
    ...
    {
        Debug.Log($"[{nameof(CrazyGamesSDKAdapter)}] Send metrica: {metrica}");
    }

    public override void SendMetrica(string metrica, IDictionary<string, string> eventParams)
    {
        Debug.Log($"[{nameof(CrazyGamesSDKAdapter)}] Send metrica: {metrica} with params");
    }

    public override void UpdateLeaderboard()
    {
        Debug.Log($"[{nameof(CrazyGamesSDKAdapter)}] Update leaderboard");
    }

    public override void ShowFullscreenAd()
    {
        Debug.Log($"[{nameof(CrazyGamesSDKAdapter)}] Show fullscreen ad");
    }
    ...
    {
        Debug.Log($"[{nameof(CrazyGamesSDKAdapter)}] OnStart");
    }

    public override void OnEnd()
    {
        Debug.Log($"[{nameof(CrazyGamesSDKAdapter)}] OnEnd");
    }

    public override void MakeReview()
    {
        Debug.Log($"[{nameof(CrazyGamesSDKAdapter)}] Make review");
    }
    ...
    {
        Debug.Log($"[{nameof(CrazyGamesSDKAdapter)}] Invoke GRA");
    }
}
